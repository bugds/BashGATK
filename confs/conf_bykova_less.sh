...
if [[ $command == 'proc' ]]; then
    ...
    export regions=/home/bioinfuser/data/bykova_less/targets_less.bed
    ...
    export regions=/home/bioinfuser/data/bykova_less/capture_targets.interval_list
    export refImg=/home/bioinfuser/data/hg38/hg38.fasta.img
    export gnomad=/home/bioinfuser/data/bykova_less/AFonly.vcf
    export variantsForContamination=/home/bioinfuser/data/bykova_less/variants_for_contamination.vcf
    ...
    export wd=/home/bioinfuser/data/bykova_less
    export regions=/home/bioinfuser/data/bykova_less/targets_less.bed
    ...
    export regionsPathPart=data/bykova_less/targets_less.bed
