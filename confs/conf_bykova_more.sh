...
if [[ $command == 'proc' ]]; then
    ...
    export regions=/home/bioinfuser/data/bykova_more/targets_more.bed
    ...
    export wd=/home/bioinfuser/data/bykova_more
    export regions=/home/bioinfuser/data/bykova_more/targets_more.bed
    ...
    export regionsPathPart=data/bykova_more/targets_more.bed
